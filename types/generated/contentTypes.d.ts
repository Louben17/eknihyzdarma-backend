...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Aktuality a novinky webu';
    displayName: '\u010Cl\u00E1nek';
    pluralName: 'articles';
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Bannery pro karusel na tituln\u00ED str\u00E1nce';
    displayName: 'Banner';
    pluralName: 'banners';
    singularName: 'banner';
  };
...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cover: Schema.Attribute.Media<'images'>;
    coverExternalUrl: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    downloads: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    ebookFiles: Schema.Attribute.Media<'files', true>;
...
export interface ApiUserFavoriteUserFavorite
  ...
  info: {
    description: 'Obl\u00EDben\u00E9 knihy u\u017Eivatele';
...
export interface ApiUserLibraryUserLibrary extends Struct.CollectionTypeSchema {
  collectionName: 'user_libraries';
  info: {
    description: 'U\u017Eivatelsk\u00E1 knihovna sta\u017Een\u00FDch knih';
    displayName: 'User Library';
    pluralName: 'user-libraries';
    singularName: 'user-library';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-library.user-library': ApiUserLibraryUserLibrary;
